...
def main(args):
    ...
    target_layers = [model.pretrained_model.srmatt2]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--savefig", type=str, default=r"G:\CISCN作品赛\processeddataset\FF++\fake\deepfakes\c23\1.png",
                        help="Path to save figure")
    parser.add_argument("--forgerytype", type=str, default="faceswap", help="forgery type")
    parser.add_argument("--class-idx", type=int, default=0, help="Index of the class to inspect")
    parser.add_argument("--device", type=str, default="cuda:0", help="Default device to perform computation on")
